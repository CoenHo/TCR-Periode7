...
New-NetIPAddress -IPAddress 192.168.5.1 -DefaultGateway 192.168.5.254 -PrefixLength 24 -AddressFamily IPv4 -InterfaceAlias Ethernet
...
Rename-Computer -NewName DC1-CoeHod2x -Restart
